            ...
            <Worksheet ss:Name="Engravings">
                <Table>
                    ...
                    <Row ss:Index="2">
                        ...
                        <Cell ss:StyleID="braceletHeader">
                            <Data ss:Type="String">Embroidery</Data>
                        </Cell>
                        <Cell ss:StyleID="braceletHeader">
                            <Data ss:Type="String">Tape Color</Data>
                        </Cell>
                        <Cell ss:StyleID="braceletHeader">
                            <Data ss:Type="String">Thread Color</Data>
                        </Cell>
                        <Cell ss:StyleID="braceletHeader">
...
objects/object/items/item[
    not(
        custom_options/custom_option[bracelet_piece='size']/value = preceding::item[
            ...
            and product_attributes/product_type='Name Tape'
        ]/custom_options/custom_option[bracelet_piece='size']/value
    )
    and not(product_type='configurable')
    and product_attributes/product_type='Name Tape'
]">
                        <xsl:sort select="custom_options/custom_option[bracelet_piece='size']/value"/>
...
/objects/object/items/item[
    ...
    and product_attributes/product_type='Name Tape'
                            ...
                            <!-- Sorts -->
                            <xsl:sort select="custom_options/custom_option[bracelet_piece='material_color']"/>
                            <xsl:sort select="custom_options/custom_option[bracelet_piece='text_color']"/>
                        </xsl:apply-templates>
                    </xsl:for-each>
                </Table>
    ...
    <xsl:template match="item">
        ...
        <Row ss:Height="52">
            ...
            <Cell ss:StyleID="braceletCenter">
                <Data ss:Type="String">
                    <xsl:value-of select="custom_options/custom_option[bracelet_piece='text_color']/value"/>
                </Data>
            </Cell>
            <Cell ss:StyleID="braceletCenter">
                <Data ss:Type="String">

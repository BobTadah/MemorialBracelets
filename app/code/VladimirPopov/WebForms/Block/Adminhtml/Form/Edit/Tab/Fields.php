    ...
    protected function _prepareColumns()
    {
        ...
        if ($modelForm->getData('show_width_lg'))
            $this->addColumn('width_lg', array(
                ...
                'options' => $fieldModel->getSizeValues(true)
            ));
        ...
        $this->_eventManager->dispatch('webforms_block_adminhtml_form_edit_tab_fields_preparecolumns', ['grid' => $this]);
        ...
        if ($modelForm->getData('show_width_lg'))
            $this->getMassactionBlock()->addItem(
                ...
                [
                    ...
                    'url' => $this->getUrl('webforms/field/massWidth', ['_current' => true]),
                    'additional' => [
                        'visibility' => [
                            'name' => 'width_lg',
                            'type' => 'select',
                            'label' => __('Width'),
                            'options' => $fieldModel->getSizeValues()
                        ]
                    ]
                ]
            );

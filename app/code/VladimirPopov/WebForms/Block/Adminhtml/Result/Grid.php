...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
            ...
            if ($field->getType() != 'html') {
                ...
                if ($this->_isExport) {
                    ...
                    if ($field->getType() == 'image' || $field->getType() == 'file') {
                        $config['renderer'] = 'VladimirPopov\WebForms\Block\Adminhtml\Result\Renderer\Export\File';
                    }
                } else {
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->_eventManager->dispatch('webforms_block_adminhtml_result_grid_massaction', ['grid' => $this]);

...
use MemorialBracelets\SupportiveMessages\Model\SupportiveMessageFactory as MessageFactory;
...
class SupportiveMessageRepository implements SupportiveMessageRepositoryInterface
{
    ...
    public function save(SupportiveMessageInterface $object)
    {
        try {
            $object->save();
        } catch (\Exception $e) {
    ...
    public function delete(SupportiveMessageInterface $object)
    {
        try {
            $object->delete();

 ...
 */
namespace MemorialBracelets\NameCategory\Block\Product\ProductList;

use MemorialBracelets\NameCategory\Helper\Product\ProductList;
...
class Toolbar extends \Magento\Framework\View\Element\Template
{
    ...
    {
        $pagerBlock = $this->getChildBlock('product_list_toolbar_pager_custom');

...
namespace MemorialBracelets\NameProduct\Model\ResourceModel\Product\Indexer\Price;

use Magento\Catalog\Api\Data\ProductInterface;
use Magento\Catalog\Model\ResourceModel\Product\Indexer\Price\DefaultPrice;
use MemorialBracelets\NameProduct\Model\ResourceModel\Product\Link;

class Name extends DefaultPrice
{
    /**
    ...
    public function reindexAll()
    {
        ...
        try {
            $this->prepareNameProductPriceData();
            $this->commit();
        } catch (\Exception $e) {
            $this->rollBack();
            throw $e;
    ...
    {
        $this->prepareNameProductPriceData($entityIds);
     ...
     * @return $this
     */
    protected function prepareNameProductPriceData($entityIds = null)
    {

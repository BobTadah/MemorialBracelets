...
namespace MemorialBracelets\NameProduct\Model\ResourceModel\Indexer\Stock;
...
class Name extends DefaultStock
{
    protected function _getStockStatusSelect($entityIds = null, $usePrimaryTable = false)
    {
        ...
        $select->reset(
            ...
            \MemorialBracelets\NameProduct\Model\ResourceModel\Product\Link::LINK_TYPE_NAME,
            []
        )->joinLeft(

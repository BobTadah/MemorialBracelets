...
class Name extends AbstractModifier
{
    ...
    const DATA_SCOPE_NAME = 'name';
    const SORT_ORDER = 20;
    const LINK_TYPE = 'name_associated';
    ...
    {
        if ($this->locator->getProduct()->getTypeId() === NameProductType::TYPE_CODE) {
                ...
                'data' => [
                    'config' => [
                        ...
                        'provider' =>
                            ...
                            . '_data_source',
                        'options' => [
                            'title' => __('Add Products to Name Group'),
                            'buttons' => [
                                [
                                    'text' => __('Cancel'),
                                    'actions' => ['closeModal']
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'label' => false,
                        'content' => __(
                            'A name product is made up of multiple, standalone products that are presented as available'
                            . ' options for fulfilling the product needs.'
                        ),
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                ...
                                'title' => __('Add Products as Options'),
                                'provider' => null,
                            ],
                        ],
                    ],

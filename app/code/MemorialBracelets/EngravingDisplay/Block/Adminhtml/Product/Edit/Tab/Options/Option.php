 ...
 */
namespace MemorialBracelets\EngravingDisplay\Block\Adminhtml\Product\Edit\Tab\Options;
        ...
        if (!$this->_values || $this->getIgnoreCaching()) {
            ...
            foreach ($optionsArr as $option) {
                ...
                if ($option->getGroupByType() == \Magento\Catalog\Model\Product\Option::OPTION_GROUP_SELECT) {
                    ...
                    $value['number_lines'] = $option->getNumberLines();
                    $value['supportive_message_price'] = $option->getSupportiveMessagePrice();
                    $value['name_engraving_price'] = $option->getNameEngravingPrice();

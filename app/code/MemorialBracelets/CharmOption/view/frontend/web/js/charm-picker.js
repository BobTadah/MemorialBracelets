define([
    ...
    $.widget('memb.CharmOptionRendererTooltip', {
        options: {
            delay: 200,
    ...
    $.widget('memb.CharmOptionRenderer', {
        options: {
            classes: {
                attributeClass: 'charm-attribute',
                attributeLabelClass: 'charm-attribute-label',
                attributeSelectedOptionLabelClass: 'charm-selected-label',
                attributeOptionsWrapper: 'charm-picker',
                optionClass: 'charm-option',
        ...
        _init: function() {
            ...
            $this.find('.' + this.options.classes.optionClass).CharmOptionRendererTooltip();
        ...
        _onChange: function($this, $widget) {
            var $parent = $this.parents('.' + $widget.options.classes.attributeClass),
                ...
                $val = $this.val(),
                $selectedElement = $val ? $selectionElements.filter('[data-charm-id=' + $this.val() + ']') : null,
                $notSelectedElements = $val ? $selectionElements.not('[data-charm-id=' + $this.val() + ']') : $selectionElements;
    ...
    return $.memb.CharmOptionRenderer;
});

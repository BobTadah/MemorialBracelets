...
define([
    ...
    return Element.extend({
        ...
        mousedownHandler: function (data, elem, event) {
            ...
            drEl.eventMousedownY = event.originalEvent.hasOwnProperty('touches') ? event.originalEvent.touches[0].pageY : event.pageY;
        ...
        mousemoveHandler: function (event) {
            var depEl = this.draggableElement,
                pageY = event.originalEvent.hasOwnProperty('touches') ? event.originalEvent.touches[0].pageY : event.pageY,

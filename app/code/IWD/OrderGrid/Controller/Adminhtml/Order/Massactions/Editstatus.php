...
class Editstatus extends AbstractMassAction
{
     ...
     * {@inheritdoc}
     */
    const ADMIN_RESOURCE = 'IWD_OrderGrid::iwdordergrid_change_status';
    ...
    protected function massAction(AbstractCollection $collection)
    {
        ...
        if (empty($status)) {
            $this->messageManager->addErrorMessage(
                __('The status of these orders cannot be changed. You may enable this option in the Order Grid settings.')
            );
        } else {

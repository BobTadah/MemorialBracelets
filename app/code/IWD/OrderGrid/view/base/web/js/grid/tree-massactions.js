...
define([
    'ko',
    'underscore',
    'IWD_OrderGrid/js/grid/massactions'
], function (ko, _, Massactions) {
    'use strict';
    return Massactions.extend({

        defaults: {
            template: 'IWD_OrderGrid/grid/tree-massactions',
        ...
        applyAction: function (actionIndex, formValue) {
            ...
            return this._super(actionIndex, formValue);
        },
        ...
        isCustomTemplate: function (type) {
            if(this[type+'Form'] !== undefined){
                return true;
            }
            return false;
        },

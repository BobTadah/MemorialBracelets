...
{
    private $fieldMap = [
        'iwd_order_discount_amount' => 'iwd_order_discount_amount',
        'iwd_order_product_name' => 'iwd_order_product_name',
        'iwd_order_product_sku' => 'iwd_order_product_sku',
        'iwd_order_invoice_number' => 'iwd_order_invoice_number',
        'iwd_order_shipment_number' => 'iwd_order_shipment_number',
        'iwd_order_creditmemo_number' => 'iwd_order_creditmemo_number',
        'iwd_invoice_total' => 'iwd_invoice_total',
        'iwd_order_discount_amount' => 'iwd_order_discount_amount',
        'iwd_order_comment_last' => 'iwd_order_comment_last',
        'iwd_order_comment' => 'iwd_order_comment',
    ];
    /**
    ...
    {
        return (bool)$this->scopeConfig->getValue('iwd_ordergrid/total/enabled');
    }
    ...
    public function beforeAddFilter(MagentoDataProvider $subject, Filter $filter)
    {
        ...
        if (isset($this->fieldMap[$field]) || strpos($field, 'shipper_order_join') !==false) {
            return;
        } else {
    ...
    {
        $sets = $this->scopeConfig->getValue('iwd_ordergrid/total/sets');
        $sets = explode(',', $sets);

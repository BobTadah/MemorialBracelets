...
namespace IWD\OrderGrid\Model\Creditmemo;
...
/**
 * Class Creditmemo
 * @package IWD\OrderGrid\Model\Creditmemo
 */
class Creditmemo extends \Magento\Sales\Model\Order\Creditmemo
{
    ...
    {
        return $this->scopeConfig->getValue('iwdorder_grid/allow_delete/credit_memos');
    }
}

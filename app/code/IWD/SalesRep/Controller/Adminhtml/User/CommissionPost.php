...
class CommissionPost extends \IWD\SalesRep\Controller\Adminhtml\AbstractUser
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $tieredOptions = $this->_request->getParam('container_tiered_options_grid');
            ...
            if(!empty($tieredOptions) && is_array($tieredOptions)) {
                $tieredOptions = json_encode($tieredOptions);
                $attachedCustomer->setData(AttachedCustomer::COMMISSION_TIERED_OPTIONS, $tieredOptions);
            }
            ...
            $attachedCustomer->addData([
                ...
                AttachedCustomer::COMMISSION_TIERED_OPTIONS => $tieredOptions,
            ]);

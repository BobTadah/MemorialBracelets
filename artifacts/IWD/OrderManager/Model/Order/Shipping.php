...
class Shipping extends AbstractModel
{
    ...
    private function getRateRequest()
    {
        ...
        //We don't pass taxClassId since getRateRequest will calculate it anyway.
        return $this->taxCalculation->getRateRequest($shippingAddress, $billingAddress, null, $store);
    }

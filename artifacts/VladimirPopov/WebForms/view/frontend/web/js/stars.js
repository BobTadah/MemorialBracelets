...
// This is the main starry widget. Create new widgets after window load
    ...
    Starry.prototype = {
        initialize: function (element) {
            ...
            document.getElementById(element + 'container').appendChild(this.element);

            while (document.getElementById(element) == null) {
                //timeout
            }
...
// this function manages an auto_increment for id's
    var id = {
        start: 0, prev: 0, next: function () {
            return this.start + this.prev++;
        }
    };
    return Starry;
})